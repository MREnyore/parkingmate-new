...
export function AccountPage() {
  ...
  // Fetch user data
  const { data: userInfo, isLoading, error } = useAdminUserInfo()
  ...
  // Error state
  if (error || (userInfo && !userInfo.success)) {
    return (
      <ErrorPage
        title="Failed to Load Account"
        message="We couldn't load your account information. Please try again."
